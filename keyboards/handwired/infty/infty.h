...
#define LAYOUT( \
        ...
        K40, K41, K42,      K44, K45, K46, K47,           K4A, K4B, K4C                \
) { \
    ...
    { K40,   K41,   K42,   KC_NO, K44,   K45,   K46,   K47,   KC_NO, KC_NO, K4A,   K4B,   K4C,   KC_NO, KC_NO }, \
}
